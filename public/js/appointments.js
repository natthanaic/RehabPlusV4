...
async function loadAppointments() {
    try {
        ...
        params.append('start_date', moment(view.activeStart).format('YYYY-MM-DD'));
        params.append('end_date', moment(view.activeEnd).format('YYYY-MM-DD'));
    ...
    const detailsHtml = `
        <div class="row">
            <div class="col-md-6">
                ...
                <p><strong>PT Number:</strong> ${appointment.pt_number}</p>
            </div>
            <div class="col-md-6">
